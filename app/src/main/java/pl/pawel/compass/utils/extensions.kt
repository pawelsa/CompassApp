...
fun Location.toAppLocation(): pl.pawel.compass.data.model.Location {
    return pl.pawel.compass.data.model.Location(this.latitude.toFloat(), this.longitude.toFloat())
}
